...
# if distance measures 'Medial-Lateral_Distance','Proximal-Distal_Distance','Proximal-Distal_Distance_sp'
    ...
    if step == 0:
        ...
        for i in range(0,len(measures)):
            if measures[i] == 'Cell Axis PDG':
                ...
                print('path issue?' + path + 'attributes' + attr_dict['attributes'][(step -1) % 2])
