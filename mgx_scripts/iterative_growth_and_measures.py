...
params_dict = {'gen_measures': False,
               ...
               #'custom_axis_spec':['Proximal-Distal_Distance', 'min'],
               'custom_axis_spec':[],
        ...
        for i in range(0,len(measures)):
            ...
            if measures[i] == 'PDGs':
                ...
                Process.Mesh__Cell_Axis__PDG__Display_Growth_Directions('StretchMax-StretchMin', 'Auto', ranges[i][0], ranges[i][1], 'Both',
                                                                        'black', 'red', '2', '5', '0.1', '0', 'No',
                                                                        '1.0')
                Process.Mesh__System__View('Yes', 'No', 'Cells', '', 'Label Heat', '', '', 'No', 'Border', '', '', '', '', '', '', '-1', '-1')

            elif measures[i] == 'v_areas':
                Process.Mesh__Heat_Map__Heat_Map_Load(
                    os.path.join(path, 'st_attributes', 'v_areas_d'+step+'_'+os.path.split(path)[-1]+'.csv'), 'Value', '1.0')
                ...
                Process.Mesh__System__View('Yes', 'No', 'Cells', '', 'Label Heat', '', '', '', 'Border', '', '', '', '',
                                           '',
                                           '', '-1', '-1')
            elif measures[i] == 'd_areas' and step > 1:
                Process.Mesh__Heat_Map__Heat_Map_Load(
